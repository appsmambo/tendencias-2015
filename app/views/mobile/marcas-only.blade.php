            ...
            <div class="col-sm-12">
                <div class="wrapper-interno">
                    ...
                    <div class="panel-yo-elijo clearfix" id="panel-yo-elijo">
                        <a href="">
                            <img src="{{url()}}/images/marcas/only/principal.jpg" alt="" class="img-responsive">
                        ...
                        <div class="compartir-galeria">
                             ...
                             <div class="compartir-galeria-redes">
                                 <ul>
                                     <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://modaripley.com/tendencias/marcas/only" target="_blank"><img src="{{url()}}/img/facebook.png" alt="facebook" /></a></li>
                                     <li><a href="https://twitter.com/home?status=Only%20-%20Las%20mejores%20marcas%20en%20Ripley%20http://bit.ly/1Nc7FWf" target="_blank"><img src="{{url()}}/img/twitter.png" alt="twitter" /></a></li>
                                 </ul>
                             </div>
                         </div>
                    </div>                    
                    <div class="panel-lookbook-index">
                        <a href=""><img src="{{url()}}/images/marcas/only/foto.jpg" alt="" class="img-responsive">
