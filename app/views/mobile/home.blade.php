            ...
            <div class="col-sm-12">
                <div class="wrapper-interno">
                    ...
                    <div class="panel-yo-elijo clearfix" id="panel-yo-elijo">
                        <a href="{{url()}}/sjp">
                            <img src="{{url()}}/images/home/1.jpg" alt="" class="img-responsive">
                            
                        </a>
                    </div>
                    <div class="panel-marcas clearfix" id="panel-marcas">
                        <a href="{{url()}}/marcas"><img src="{{url()}}/images/home/2.jpg" alt="" class="img-responsive">
                            
                        </a>
                    </div>
                    <div class="panel-lookbook-index">
                        <a href="{{url()}}/lookbook"><img src="{{url()}}/images/home/3.jpg" alt="" class="img-responsive">
                            
                        </a>
                    </div>
                    <div class="panel-accesorios-index">
                        <a href="{{url()}}/accesorios"><img src="{{url()}}/images/home/accesorios.jpg" alt="" class="img-responsive">
