...
<div class="row">
	<div class="col-sm-6 col-sm-offset-3 marcas-nuevas">
		<img src="{{url()}}/img/marcas/veromoda/logo.png" class="img-responsive center-block" alt="espirit" />
		<p>
			Veromoda Marca Danesa.
		</p>
		<a href="http://www.veromoda.com/?forcecountry=GB&customerGroupTrigger=mobile&redirected=1" target="_blank"><img src="{{url()}}/img/marcas/veromoda/boton.jpg" class="img-responsive center-block" alt="espirit" /></a>
	</div>
</div>
<img src="{{url()}}/img/marcas/veromoda/banner.jpg" class="img-responsive" alt="espirit" />
@stop
